...
<div class="container-fluid mt-4 ">
    <div class="row">
        <div class="col-12 col-md-3 align-self-end">
            <h4 class="text-uppercase"><i class="fa fa-bars" aria-hidden="true"></i> Item Return</h4>
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-6  align-self-center alert alert-primary" role="alert">
            ...
            <div class="form-group">
                <label for="msgbox"> Messagebox </label>
    ...
    <div class="row justify-content-center">
        <div class="col-6 col-md-6">
            <button type="button" class="btn btn-primary text-right">Return</button>
        </div>
    </div>
</div>
