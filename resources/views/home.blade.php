...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="#"><img src="SystemImage/logo.png" style="width: 200px;" alt=""></a>
        ...
        <div class="col-3 align-self-end">
            <ul class="list-group">
                <li class="list-group-item">
                    <a href="#" class="dropdown-toggle" id="item" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Fashion Items
                    </a>
                ...
                <li class="list-group-item">Mens Items</li>
